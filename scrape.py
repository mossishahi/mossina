...
def main():
    ...
    parser.add_argument("--wizzair-api-url", type=str, default=None,
                        help="Wizzair API base URL (e.g. https://be.wizzair.com/23.1.0/Api). "
                             "Skips homepage discovery which is blocked on servers.")
    parser.add_argument("--db", type=str, default=None)
    args = parser.parse_args()

    if args.wizzair_api_url:
        from src.scraper.wizzair.api import set_api_url
        set_api_url(args.wizzair_api_url)
    ...
    from src.scraper.wizzair.api import set_db
    set_db(conn)
